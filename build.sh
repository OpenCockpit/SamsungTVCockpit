...
mkdir -p etc/enigma2
cp -ra ../src/skin/. ./etc/enigma2
rm -rf ../src/skin
mkdir -p usr/lib/enigma2/python/Plugins/Extensions/SamsungTV
cp -ra ../src/. ./usr/lib/enigma2/python/Plugins/Extensions/SamsungTV
tar -cvzf data.tar.gz usr etc
